...
(function (global, factory) {
  ...
  function SweetAlert() {
    ...
    if (typeof Promise === 'undefined') {
      error('This package requires a Promise blog_library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)');
    }
